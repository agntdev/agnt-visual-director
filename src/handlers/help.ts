...
const HELP =
  "Use Create image for a prompt, or Edit image after uploading a file. I’ll ask only for details that affect the result.\n\n" +
  "Use /start for the menu. Shortcuts: /new, /edit, and /cancel.";
